...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="index.blade.php">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><a type="submit" href="index.blade.php" class="btn btn-success" /> Login</a></span>
                </div>
            </form>
